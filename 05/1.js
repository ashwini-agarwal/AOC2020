...
for (let count = 0; count < 7; count++) {
  ...
  if (temp.length) {
    ...
    row_bracket[1] = (row_bracket[0] + row_bracket[1] + 1) / 2 - 1;
  }
}
...
for (let count = 7; count < 10; count++) {
  ...
  if (temp.length) {
    ...
    seat_bracket[1] = (seat_bracket[0] + seat_bracket[1] + 1) / 2 - 1;
  }
}

console.log(row_bracket, seat_bracket);
console.log(row_bracket[0] * 8 + seat_bracket[0]);
